...
// For client-side calls (browser) - HARDCODED FOR PRODUCTION
const CLIENT_API_BASE = "https://meglermonitor-api.onrender.com";

// For server-side calls (SSR) - HARDCODED FOR PRODUCTION  
